...
namespace MovilApp.Controllers
{
    class FacturaManager
    {
        ...
        string Urlpost = "http://192.168.159.1:45455/api/Factura";
        string UrlGetLastId = "http://192.168.159.1:45455/api/factura/getLastID";
        string UrlActualizarMonto = "http://192.168.159.1:45455/api/factura/actualizarMonto";
        string UrlEstadoPagado = "http://192.168.159.1:45455/api/factura/actualizarEstado";
        ...
        public async Task<IEnumerable<Factura>> ObtenerFactura(Factura factura)
        {
            ...
            string resultado = await httpClient.GetStringAsync($"http://192.168.159.1:45455/api/factura/obtenerFacturas?usuarioID={factura.USUARIO_ID}");
